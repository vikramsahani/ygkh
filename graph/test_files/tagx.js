...
var orginalRequireFn;
if('undefined' !== typeof(require)) {
    orginalRequireFn = require;
}
...
TAGX.Utils = (function(){
    ...
    utils.QsTomap = function() {
        var nvp = location.search.replace('?','').split("&");
        var map = {};
...
TAGX.ScrollManager = (function () {
    ...
    scrollWatcher.elementInViewport = function (el) {
    ...
    scrollWatcher.isElementVisible = function(oArg) {
        ...
        if (scrollWatcher.elementInViewport(element)) {
...
TAGX.EventProxy = (function () {
    ...
    var analyticsAreReady = function() {
            // this checks for WT and ET being on the page
            var ret = (window.NYTD && window.NYTD.EventTracker && window.dcsMultiTrack) ? true : false;   
            return ret; 
    };
